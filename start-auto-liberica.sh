...
java -DSTART_TIME=$START_TIME -Dspring.context.checkpoint=onRefresh -XX:CRaCCheckpointTo=./tmp_auto_checkpoint_liberica -jar build/libs/spring-petclinic-3.3.0.jar
