...
java -DSTART_TIME=$START_TIME -XX:CRaCEngine=warp -XX:CRaCCheckpointTo=./tmp_manual_checkpoint_warp_no_compression -jar build/libs/spring-petclinic-3.3.0.jar
