...
java -DSTART_TIME=$START_TIME -XX:CRaCEngine=warp -XX:CRaCEngineOptions='compression=true' -XX:CRaCCheckpointTo=./tmp_manual_checkpoint_warp -jar build/libs/spring-petclinic-3.3.0.jar
